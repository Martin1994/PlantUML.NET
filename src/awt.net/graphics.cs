...
namespace ikvm.awt
{
        ...
        public override void drawString(String text, float x, float y)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    NetFontMetrics metrics = new NetFontMetrics(font);
                    y -= baseline;
    ...
    {
        public NetGraphicsConfiguration()
        {
        }
        ...
        {
            return new java.awt.Rectangle(Int32.MinValue, Int32.MinValue, Int32.MaxValue, Int32.MaxValue);
        }
    ...
    class NetGraphicsDevice : java.awt.GraphicsDevice
    {
        ...
        internal NetGraphicsDevice()
        {
        }

        public override java.awt.GraphicsConfiguration[] getConfigurations()
        {
            return new NetGraphicsConfiguration[] { new NetGraphicsConfiguration() };
        }
    ...
    public class NetGraphicsEnvironment : java.awt.GraphicsEnvironment
    {
        ...
        {
            return new java.awt.GraphicsDevice[0];
        }
    }
